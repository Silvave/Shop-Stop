...
module.exports = (app) => {
  ...
  app.post('/product/add', auth.isAuthenticated,
    upload.single('image'),controllers.product.addPost)
  ...
  app.get('/category/:category/products', auth.isAuthenticated,
    controllers.category.productByCategory)

  app.get('/product/edit/:id', auth.isAuthenticated, controllers.product.editGet)
  app.post('/product/edit/:id', auth.isAuthenticated,
    upload.single('image'),controllers.product.editPost)
